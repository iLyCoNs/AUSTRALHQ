...
// Nuevas skins: CEO (nuevo look militar), NICOLE (nuevo), ABOGADA (pelirroja)
const SPRITES=['CEO', 'NICOLE', 'ABOGADA'];

(async()=>{
  console.log('=== GENERANDO _norm.png PARA CEO, NICOLE Y ABOGADA ===');
  ...
  await b.close();
  console.log('\n✓ CEO_norm.png + NICOLE_norm.png + ABOGADA_norm.png GENERADOS CORRECTAMENTE!');
